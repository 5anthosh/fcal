...
function getDefaultFunction() {
    const functions = new function_1.FcalFunctions();
    const abs = new function_1.FcalFunction('abs', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    abs.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.abs());
    };
    functions.add(abs);
    const sqrt = new function_1.FcalFunction('sqrt', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    sqrt.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.sqrt());
    };
    functions.add(sqrt);
    const cbrt = new function_1.FcalFunction('cbrt', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    cbrt.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.cbrt());
    };
    functions.add(cbrt);
    const log = new function_1.FcalFunction('log', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    log.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.log());
    };
    functions.add(log);
    const ln = new function_1.FcalFunction('ln', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    ln.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.ln());
    };
    functions.add(ln);
    const round = new function_1.FcalFunction('round', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    round.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.round());
    };
    functions.add(round);
    const floor = new function_1.FcalFunction('floor', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    floor.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.floor());
    };
    functions.add(floor);
    const ceil = new function_1.FcalFunction('ceil', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    ceil.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.ceil());
    };
    functions.add(ceil);
    const cosine = new function_1.FcalFunction('cos', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    cosine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.cosine());
    };
    functions.add(cosine);
    const inverseCosine = new function_1.FcalFunction('acos', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseCosine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.inverseCosine());
    };
    functions.add(inverseCosine);
    const hyperbolicCosine = new function_1.FcalFunction('cosh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    hyperbolicCosine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.hyperbolicCosine());
    };
    functions.add(hyperbolicCosine);
    const inverseHyperbolicCosine = new function_1.FcalFunction('acosh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseHyperbolicCosine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.inverseHyperbolicCosine());
    };
    functions.add(inverseHyperbolicCosine);
    const sine = new function_1.FcalFunction('sin', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    sine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.sine());
    };
    functions.add(sine);
    const inverseSine = new function_1.FcalFunction('asin', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseSine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.inverseSine());
    };
    functions.add(inverseSine);
    const hyperbolicSine = new function_1.FcalFunction('sinh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    hyperbolicSine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.hyperbolicSine());
    };
    functions.add(hyperbolicSine);
    const inverseHyperbolicSine = new function_1.FcalFunction('asinh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseHyperbolicSine.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.inverseHyperbolicSine());
    };
    functions.add(inverseHyperbolicSine);
    const tangent = new function_1.FcalFunction('tan', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    tangent.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.tangent());
    };
    functions.add(tangent);
    const inverseTangent = new function_1.FcalFunction('atan', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseTangent.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.inverseTangent());
    };
    functions.add(inverseTangent);
    const hyperbolicTangent = new function_1.FcalFunction('tanh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    hyperbolicTangent.function = function (_environment, ...argument) {
        const value = argument[0];
        return value.newNumeric(value.number.hyperbolicTangent());
    };
    functions.add(hyperbolicTangent);
    const inverseHyperbolicTangent = new function_1.FcalFunction('atanh', 1);
    // tslint:disable-next-line: only-arrow-functions variable-name
    inverseHyperbolicTangent.function = function (_environment, ...argument) {
        const value = argument[0];
...
},{"./interpreter/function":5}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../types/datatype":13}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const datatype_1 = require("../types/datatype");
class FcalFunction {
...
},{"../types/datatype":13}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const token_1 = require("../lex/token");
...
},{"../lex/token":9,"../parser/parser":12,"../types/datatype":13}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Char {
}
...
},{"../types/datatype":13,"./char":7,"./token":9}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var TokenType;
(function (TokenType) {
...
(function (Expr) {
    ...
    class UnitExpr extends Expr {
        constructor(expression, unit, start, end) {
            super(start, end);
            this.unit = unit;
            this.expression = expression;
        }
...
},{"./astPrinter":10}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    assignment() {
        ...
        if (this.match(token_1.TokenType.EQUAL)) {
            ...
            if (expr instanceof expr_1.Expr.Variable) {
                const name = expr.name;
                return new expr_1.Expr.Assign(name, expres, expr.start, expres.end);
            }
        }
        return expr;
    }
...
},{"../lex/lex":8,"../lex/token":9,"./expr":11}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const Big = require("decimal.js");
class Type {
